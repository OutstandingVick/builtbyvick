export default function Hero() {
  return (
    <section
      id="home"
      className="hero-section relative mx-auto flex min-h-screen w-full max-w-6xlflex-col items-center justify-center px-5 pb-16 pt-36 text-center max-[760px]:min-h-[100svh] max-[760px]:px-4 max-[760px]:pb-12 max-[760px]:pt-28"
    >
      ...
      <h1 className="font-display hero-title mb-5 text-[clamp(3rem,7vw,6.1rem)] font-black leading-[0.9] tracking-[-0.045em] text-(--text) max-[760px]:text-[2.55rem] max-[760px]:leading-none max-[520px]:text-[2.15rem] max-[380px]:text-[1.82rem]">
      ...
      <p className="font-mono hero-bio mb-8 max-w-[45rem] text-[1.08rem] font-semibold leading-[1.7] text-(--text-2) max-[760px]:text-[0.95rem] max-[760px]:leading-[1.65]">
