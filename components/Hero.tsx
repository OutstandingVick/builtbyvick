export default function Hero() {
  return (
    <section
      id="home"
      className="hero-section relative mx-auto flex min-h-svh w-full max-w-280 flex-col items-center justify-center px-6 pb-8 pt-10 text-center max-[760px]:w-[calc(100%-2rem)] max-[760px]:px-4 max-[760px]:pb-6 max-[760px]:pt-10 max-[380px]:w-[calc(100%-1.5rem)] max-[380px]:px-3"
    >
      <div className="hero-badge mb-9 inline-flex max-w-full items-center justify-center gap-2 px-3.5 py-1.5 max-[760px]:mb-8 max-[520px]:mb-6">
        ...
        <span className="font-mono text-base tracking-[0.12em] text-(--text-2) max-[760px]:text-base max-[520px]:text-xs">
          AVAILABLE FOR ROLES
        </span>
      </div>
      <br />
